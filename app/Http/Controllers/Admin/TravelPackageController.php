...
use App\Http\Requests\Admin\TravelPackageRequest; // dimasukan manual -> untuk form validation
...
class TravelPackageController extends Controller
{
    ...
    public function update(TravelPackageRequest $request, $id)
    {
        ...
        $item = TravelPackage::findOrFail($id); // outputnya hasil record awal pada database
